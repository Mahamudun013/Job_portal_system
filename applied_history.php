   ...
   <!-- <div class="col-md-10 col-md-offset-1"> -->
      ...
      ?>  
          ...
          <tr class="success">
            ...
            <td>
              <a href="admin_action.php?apply_id=<?php echo $row['id'] ?>" class="btn btn-danger" onclick=" return confirm('Are you sure to delete?')"><span class="glyphicon glyphicon-trash"></span></a>
            </td>
          </tr>
        </tbody>
